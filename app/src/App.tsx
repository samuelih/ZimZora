...
import { StudioUI } from './components/studio';
...
function App() {
  ...
  // For dark-themed paradigms (orbital, node-graph, layers, studio)
  const isDarkParadigm = ['orbital', 'node-graph', 'layers', 'studio'].includes(currentParadigm);
